# Glassy — three magazine concepts

One idea — a **premium, multi-market (US / 日本 / 中文) online magazine for Korean beauty & dermatology *trends***, curated with taste and sourced from Seoul, with a light MD trust layer — built **three ways**. Each concept clones the design language **and** the business model of a different, genuinely successful business.
...
A gallery at the root lets you compare the three and pick.

## Build

```bash
pip install markdown
python build.py     # renders index.html (gallery) + v1/ v2/ v3/ (home + articles each)
```
